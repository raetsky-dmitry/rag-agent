...
- Для добавления товара в корзину используй инструмент add_to_cart 
- Для получения общей суммы корзины (с учетом скидок) используй инструмент get_cart_summary 
